...
main: accessdata.o moyenne_vues.o moyenne_like_dislike.o generation_fichier_ID.o ID_vers_CAT.o main.o
	$(CC) -o $@ $^
...
accessdata.o: model/acces_donnee/accessdata.c model/id_vers_cat/ID_vers_CAT.c
	$(CC) -o $@ -c $< $(FLAGS)

affichage_VIDEO.h: vue/affichage_VIDEO.c
	$(CC) -o $@ -c $< $(FLAGS)
